...
1. **Score** (1-100) with breakdown by category
2. **Quick Wins** — changes that take < 5 minutes and have high impact
3. **Strategic Improvements** — larger changes with significant upside
4. **What's Working** — elements to keep as-is
